...
After successful installation, access application at. 
```text
https://wmai-analytics.[mycompany].com
```
The Analytics URL is displayed in the terminal output after successful execution of the `install-ai-observability.sh` script.
