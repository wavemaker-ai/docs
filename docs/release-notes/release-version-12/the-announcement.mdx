...
### Agent-Based Development ([AIRA](../../developing-with-agents/))
...
### Design to Code ([Design to code](../../design-system/figma-design-to-code-plugin/working-with-design-to-code-plugin))
...
[Design to Code](../../design-system/figma-design-to-code-plugin/working-with-design-to-code-plugin) is a figma plugin that converts supported designs into WaveMaker applications using a design-first approach.
...
WaveMaker AI introduces [Aira](../../developing-with-agents/), an AI agent framework designed to assist across the application development lifecycle.
