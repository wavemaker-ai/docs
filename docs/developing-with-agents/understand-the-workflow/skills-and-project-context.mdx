...
WaveMaker AI Assistant combines current project context with reusable development skills. Project context tells the agent what exists; skills tell it how to perform a particular kind of work.
...
The assistant starts with skill names and short descriptions. It loads complete instructions when a request matches a skill. This keeps unrelated database or mobile instructions out of a focused UI task.
