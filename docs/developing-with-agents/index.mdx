...
<div className="agent-framework-diagram">
  <img src={require('./assets/img/wavemaker-agentic-framework.webp').default} alt="WaveMaker agent development framework showing developer workflows, application context, MCP, and WaveMaker platform services" />
</div>
